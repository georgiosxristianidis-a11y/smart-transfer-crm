...
| 3 | Timezone: UTC dates in a local context (+3) | 🔵 | ✅ **merged** | audit/04 |
...
| 16 | **DRIVE-01** — nothing animates on a windshield | 🟢 | ✅ **merged** | NAV_SPEC |
| 17 | **DEV-01** — version in UI + diagnostics screen behind 5 taps | 🔵 | — | NAV_SPEC |
| 18 | Full `innerHTML` re-render + subscription leak | 🔵 | — | audit/10 |
| 19 | Demo fuel data shipped to a real user | 🔵 | — | audit/11 |
| 20 | `alert`/`confirm` and modals without a11y | 🟢 | — | audit/12 |
| 21 | Magic numbers and division by zero in calculations | 🔵 | — | audit/13 |
| 22 | View layer untested (~800 lines, 0%) | 🔵 | — | audit/09 |
| 23 | **CALC-00** — licence regime (ΕΔΧ / ΕΙΧ) and minimum fare | 🟠 | ✅ **merged** | economics review |
| 24 | **CALC-01** — input VAT 24% is never reclaimed (≈€4 900/yr overstated) | 🟠 card · 🔵 code | — | economics review |
| 25 | **CALC-02** — hotel commission per pickup: absent from the model entirely | 🟠 card · 🔵 code | — | economics review |
| 26 | **CALC-03** — shoulder and winter seasons; winter reserve replaces the 5% magic number | 🔵 | — | economics review |
| 27 | **CALC-04** — depreciation, 22% profit tax, break-even fare | 🟠 card · 🔵 code | — | economics review |
