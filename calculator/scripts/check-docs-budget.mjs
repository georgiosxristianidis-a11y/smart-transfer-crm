 ...
 *
 * cards — рабочие карточки: одна задача, один экран. Не влезло — это не карточка.
 * audit — находки аудита: другой жанр, там симптом с корнем и разбором, лимит шире.
 */
const PER_FILE_BUDGET = {
  'docs/handoff/cards': 2000,
  'docs/handoff/audit': 2500,
};
